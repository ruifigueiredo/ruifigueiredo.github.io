...
$aliases['dev'] = array(
    'uri' => 'localhost/ruifigueiredo',
    'root' => '/public_html/ruifigueiredo',
    'path-aliases' => array(
      '%drush' => '/users/rui/dev/drush',
      '%drush-script' => '/users/rui/dev/drush/drush',
      '%dump-dir' => '/sites/SQL/dumps/',
      '%dump' => '/sites/SQL/sql-dev.sql',
      '%files' => 'sites/ruifigueiredo.me/files',
     ),
  );
 
$aliases['stage'] = array(
    'uri' => 'ruifigueiredo.me',
    'root' => '/public_html',
    'path-aliases' => array(
      '%drush' => '/drush',
      '%drush-script' => '/drush',
      '%dump-dir' => '/sites/SQL/dumps/',
      '%dump' => '/sites/SQL/sql-stage.sql',
      '%files' => 'sites/files',
     ),
  );